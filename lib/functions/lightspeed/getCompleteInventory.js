...
const getCompleteInventory = (authHeader, accountID) => {
          ...
          setTimeout(() => {
            axios({
              ...
              .then((response) => {
                ...
                items[0] ? (fullInventory = fullInventory.concat(items)) : fullInventory.push(items);
...
module.exports = getCompleteInventory;
